 ...
 select * from crawl_data.apt2_new;
 
 
 
 update crawl_data.apt2_new 
set 거래금액범위 = 
	 case 
...
select 월, 일, 시, 구, 법정동, 단지, 전용면적, 거래금액 , 등록일자 FROM crawl_data.apt2_new order by 등록일자 desc limit 10;